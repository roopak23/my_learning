CREATE TABLE IF NOT EXISTS `TRF_Monitoring_Insights` (
	`report_id` STRING,
	`date_update` DATE,
	`creation_date` DATE,
	`brand_id` STRING,
...
STORED AS ORC
LOCATION '{{ params.TABLEHOST }}://{{ params.ROOTPATH }}/{{ params.HIVE_DATA_PATH }}/TRF_Monitoring_Insights'
TBLPROPERTIES("transactional"="true");

MSCK REPAIR TABLE `TRF_Monitoring_Insights`;