CREATE TABLE IF NOT EXISTS `STG_AdServer_NetworkBackfillImpressions` (
...
STORED AS ORC
LOCATION '{{ params.TABLEHOST }}://{{ params.ROOTPATH }}/{{ params.HIVE_DATA_PATH }}/STG_AdServer_NetworkBackfillImpressions'
TBLPROPERTIES("transactional"="true");

msck repair table `STG_AdServer_NetworkBackfillImpressions`;