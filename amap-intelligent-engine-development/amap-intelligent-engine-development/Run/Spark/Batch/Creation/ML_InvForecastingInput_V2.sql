CREATE TABLE IF NOT EXISTS `ML_InvForecastingInput_V2` (
    `date` date, 
    `adserver_id` string, 
...
STORED AS ORC
LOCATION '{{ params.TABLEHOST }}://{{ params.ROOTPATH }}/{{ params.HIVE_DATA_PATH }}/ML_InvForecastingInput_V2'
TBLPROPERTIES("transactional"="true");

msck repair table `ML_InvForecastingInput_V2`;