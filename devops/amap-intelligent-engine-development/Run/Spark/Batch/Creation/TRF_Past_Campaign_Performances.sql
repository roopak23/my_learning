CREATE TABLE IF NOT EXISTS `TRF_Past_Campaign_Performances` (
...
STORED AS ORC
LOCATION '{{ params.TABLEHOST }}://{{ params.ROOTPATH }}/{{ params.HIVE_DATA_PATH }}/TRF_Past_Campaign_Performances'
TBLPROPERTIES("transactional"="true");

MSCK REPAIR TABLE `TRF_Past_Campaign_Performances`;